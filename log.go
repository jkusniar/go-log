// Package log is another implementation of logger in golang. It is dead simple, supports loglevels.
// File writing thread-safety is achieved by channels. Struct fileds thread-safety is achieved using locks
// on proper places.
// TODO: Log rotation using lumberjack library
package log
